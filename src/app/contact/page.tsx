...
import { RiCalendarCheckLine, RiMailLine, RiMapPin2Line, RiPhoneLine, RiTimeLine } from "react-icons/ri";
      ...
      <section className="relative overflow-hidden bg-white py-24 md:py-32">
        ...
        <div className="container-x relative">
          <div className="max-w-3xl">
            ...
            <h1 className="h-display mt-6">Let&apos;s talk <span className="text-brand">pipeline.</span></h1>
          ...
          <div className="grid grid-cols-1 gap-16 lg:grid-cols-12 lg:gap-24">
            ...
            <aside className="lg:col-span-5">
              <div className="space-y-8">
                <div>
                  <h3 className="text-2xl font-bold text-ink">Get in touch directly</h3>
                  <p className="mt-4 text-body">Skip the form? Reach out via any of these channels. Our team is responsive.</p>
                </div>
                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-1">
                  <div className="flex items-center gap-6 rounded-3xl border border-line bg-white p-6 shadow-sm">
                    ...
                    <div>
                      ...
                      <p className="mt-1 font-semibold text-ink">hello@yubamedia.com</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-6 rounded-3xl border border-line bg-white p-6 shadow-sm">
                    ...
                    <div>
                      ...
                      <p className="mt-1 font-semibold text-ink">+1 (555) 010-2025</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-6 rounded-3xl border border-line bg-white p-6 shadow-sm">
                    ...
                    <div>
                      <p className="text-xs font-bold uppercase tracking-widest text-muted">Region</p>
                      <p className="mt-1 font-semibold text-ink">North America (US & Canada)</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-6 rounded-3xl border border-line bg-white p-6 shadow-sm">
                    ...
                    <div>
                      <p className="text-xs font-bold uppercase tracking-widest text-muted">Business Hours</p>
                      <p className="mt-1 font-semibold text-ink">Mon–Fri, 9am–6pm EST</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="rounded-[2rem] bg-ink p-8 text-white shadow-xl shadow-ink/10">
                  ...
                  <p className="mt-4 text-sm leading-relaxed text-white/70">
                    We review all inquiries within 24 business hours. For existing 
                    clients, please reach out directly via your dedicated Slack channel.
                  </p>
                </div>
              </div>
            </aside>
